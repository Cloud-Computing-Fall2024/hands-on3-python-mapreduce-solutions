...
```bash
docker cp mapper_task1.py resourcemanager:/opt/hadoop-3.2.1/share/hadoop/mapreduce/
docker cp reducer_task1.py resourcemanager:/opt/hadoop-3.2.1/share/hadoop/mapreduce/
docker cp mapper_task2.py resourcemanager:/opt/hadoop-3.2.1/share/hadoop/mapreduce/
